...
// 17. Nov 2015 ersetzt nun php-Programm
 ...
 function gewinn1(a,b) {
   var gewinn_betrag=0;
   if ((a==6) && (b==1)) gewinn_betrag=1500000;      
   if ((a==6) && (b==0)) gewinn_betrag=1000000;
   if ((a==5) && (b==1)) gewinn_betrag=10000;
   if ((a==5) && (b==0)) gewinn_betrag=1000;
   if ((a==4) && (b==1)) gewinn_betrag=150;
   if ((a==4) && (b==0)) gewinn_betrag=75;
   if ((a==3) && (b==1)) gewinn_betrag=25;
   if ((a==3) && (b==0)) gewinn_betrag=10;          
   return gewinn_betrag;	
 }

function ziehe() { 
document.getElementById("txt").innerHTML="<h3>Resultate der Simulation Swisslotto</h3>";
   ...
   for (var i=1; i<n+1; i++) {  // Ziehung
    ...
    if (n==1) {
        ...
        document.getElementById("txt").innerHTML+="<h4>"+a+z+s+"</h4>";
        Gewinnsumme+=gewinn1(a,b); 		
    }
  }
