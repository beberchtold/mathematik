...
// Mai 2020: infos.html in separatem Fenster

   var n=1;
   var z1,z2,z3,z4,z5;
   var s1,s2;
   var zahl=new Array(6);
   const Kosten_pro_Tipp=2.2;
 ...
 function gewinn1(a,b) {
   var gewinn_betrag=0;
   if ((a==5) && (b==2)) gewinn_betrag=59710300;      
   if ((a==5) && (b==1)) gewinn_betrag=436000;
   if ((a==5) && (b==0)) gewinn_betrag=61530;
   if ((a==4) && (b==2)) gewinn_betrag=3305;
   if ((a==4) && (b==1)) gewinn_betrag=165;
   if ((a==4) && (b==0)) gewinn_betrag=105;
   if ((a==3) && (b==2)) gewinn_betrag=58;
   ...
   if ((a==2) && (b==0)) gewinn_betrag=4.3;
   return gewinn_betrag;	
 }
 
 function ziehe() {
   document.getElementById("txt").innerHTML="<h3>Resultate der Simulation Euromillions</h3>";
   ...
   var einbezahlte_Summe_Euro=runde(n*Kosten_pro_Tipp);
   var Gewinnsumme=0; 
   var gewinn=false;
   for (var i=1; i<n+1; i++) {  // Ziehung
    ...
    if (n==1) {
        ...
        document.getElementById("txt").innerHTML+=zahl[6];   
        document.getElementById("txt").innerHTML+="<h4>Sie haben "+a+z+b+s+"</h4>"; 
        Gewinnsumme+=gewinn1(a,b);    
    }
  }
  ...
  var bilanz=runde(Gewinnsumme-einbezahlte_Summe_Euro);
  document.getElementById("txt").innerHTML+="<br>Sie haben <b>"+einbezahlte_Summe_Euro+"</b> Euro eingesetzt<br>";
  document.getElementById("txt").innerHTML+="Sie haben <b>"+Gewinnsumme+"</b> Euro gewonnen<br>"; 
  if (bilanz>0)
    document.getElementById("txt").innerHTML+="Sie haben einen Gewinn von <b>"+bilanz+"</b> Euro erzielt!<br>";
  if (bilanz==0)
    document.getElementById("txt").innerHTML+="Sie haben weder gewonnen noch verloren!<br>";
  if (bilanz<0)
    { bilanz=bilanz*(-1);
      document.getElementById("txt").innerHTML+="Sie haben einen Verlust von <b>"+bilanz+"</b> Euro erlitten!<br>";   	
    }
 }
