...
window.onload=init;	
  ...
  function resizeCanvas() {
	...
	if (initmade) {
	  resize1();
	  if (mode==2) zeichnelpunkt();
	  if (mode==3) zeichnerpunkt();
	  if (mode==1) zeichnetrapez();
	  if (mode==4) zeichnempunkt();
	  zeichneKS();
	  zeichne_funktion();
	} else init();	
  }
  ...
  function button1() {
	...
	document.getElementById(mode).style.backgroundColor ="#00FF00";
	leereResultate();
	document.getElementById("trapez").style.backgroundColor="Aquamarine";
	document.getElementById("trapez").style.fontWeight="bold";
	document.getElementById("trapez").innerHTML=restrapez;
	document.getElementById("lpunkt").innerHTML=reslpunkt;
	document.getElementById("rpunkt").innerHTML=resrpunkt;
	document.getElementById("mpunkt").innerHTML=resmpunkt;
  ...
  function button2() {
	...
	document.getElementById(mode).style.backgroundColor ="#00FF00";
	leereResultate();
	document.getElementById("lpunkt").style.backgroundColor="Aquamarine";
	document.getElementById("lpunkt").style.fontWeight="bold";
	document.getElementById("lpunkt").innerHTML=reslpunkt;
	document.getElementById("rpunkt").innerHTML=resrpunkt;
	document.getElementById("trapez").innerHTML=restrapez;
	document.getElementById("mpunkt").innerHTML=resmpunkt;
  ...
  function button3() {
	...
	document.getElementById(mode).style.backgroundColor ="#00FF00";
	leereResultate();
	document.getElementById("rpunkt").style.backgroundColor="Aquamarine";
	document.getElementById("rpunkt").style.fontWeight="bold";
	document.getElementById("rpunkt").innerHTML=resrpunkt;
	document.getElementById("lpunkt").innerHTML=reslpunkt;
	document.getElementById("trapez").innerHTML=restrapez;
	document.getElementById("mpunkt").innerHTML=resmpunkt;
  ...
  function button4() {
	...
	document.getElementById(mode).style.backgroundColor ="#00FF00";
	leereResultate();
	document.getElementById("mpunkt").style.backgroundColor="Aquamarine";
	document.getElementById("mpunkt").style.fontWeight="bold";
	document.getElementById("rpunkt").innerHTML=resrpunkt;
	document.getElementById("lpunkt").innerHTML=reslpunkt;
	document.getElementById("trapez").innerHTML=restrapez;
	document.getElementById("mpunkt").innerHTML=resmpunkt;
  ...
  function leereResultate(){
	document.getElementById("trapez").style.backgroundColor="white";
	document.getElementById("lpunkt").style.backgroundColor="white";
	document.getElementById("rpunkt").style.backgroundColor="white";
	document.getElementById("mpunkt").style.backgroundColor="white";
	document.getElementById("trapez").style.fontWeight="normal";
	document.getElementById("lpunkt").style.fontWeight="normal";
	document.getElementById("rpunkt").style.fontWeight="normal";
	document.getElementById("mpunkt").style.fontWeight="normal";
